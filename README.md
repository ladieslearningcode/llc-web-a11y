...
## Accessibilité Web avec le HTML et le CSS

Atelier d’une journée sur le HTML et le CSS axé sur l'accessibilité Web.
Cet atelier est une initiation au HTML et aux CSS pour les personnes n'ayant aucune expérience en la matière.

### Liens rapides

Diapositives : https://ladieslearningcode.github.io/llc-web-a11y/slides-fr.html

Notes de la formatrice : https://ladieslearningcode.github.io/llc-web-a11y/notes-fr.html

### Attributions

Contenu créé par Stacie Daponte pour [Canada en programmation](https://www.canadalearningcode.ca/), avec la collaboration de Jesse R Mykolyn.

Diapositives créées par [Christina Truong](http://christinatruong.com/) pour [Canada en programmation](https://www.canadalearningcode.ca/).
